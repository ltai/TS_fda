/* This is Robinson's code in his PhD thesis, created at 2012 
 * which requires many other subroutines. Need all of them to have
 * the code working. Currently missing. Need to download from the web site again.
 * 
...
#include "mex.h"
#include <math.h>
#include "dp_grid.c" /* dp_grid.c include dp_grid.h and dp_nbhd.h */
